...
pub fn check_venue(venue: String) -> Result<String, String> {

    let request = Request {
        requires_auth: false,
        request_url: format!("https://api.stockfighter.io/ob/api/venues/{}/heartbeat",
                             venue),
    };
